...
ui <- fluidPage(theme = my_theme,
    ...
    tabPanel("Modelo",
             column(12,
                    ...
                    uiOutput('ex2'),
                    h1("¿Qué es el modelo de regresión lineal?"),
                    ...
                    p("Se puede observar los residuales, que son la diferencia de
                      ...
                      la cual se desea fuera lo más pequeña posible. En el 
                    ...
                    p("Por ejemplo un jugador cuyo peso sea de 52 kilos
                      su edad sea de 15 años y su IMC de 19... ¡este jugador es
                      Bruno!"),
...
server <- function(input, output) {
    ...
    output$bruno2 <- renderImage({
        filename <- normalizePath(file.path('./images',
                                            paste('bruno2', input$n, '.png', sep = '')))
        list(src = filename)
    }, deleteFile = FALSE)
